...
},{}],"../../js/consultancyHeaderAnims.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.animateConultancyHeaderStart = animateConultancyHeaderStart;

var _svg = require("@svgdotjs/svg.js");

function animateConultancyHeaderStart() {
  var consultancySvgBg = (0, _svg.SVG)(".consultancy-background svg"); // Always animate

  var svgPathsAnimOnLoad = ['#branch-1-path-1', '#branch-2-path-1', '#branch-1-path-2', '#branch-1-path-3'];
  svgPathsAnimOnLoad.forEach(function (pathId) {
    var pathRef = (0, _svg.SVG)(pathId);
    pathRef.attr({
      class: "path-anim-slow"
    });
    var pathLen = pathRef.length();
    pathRef.stroke({
      dasharray: pathLen,
      dashoffset: pathLen
    });
...
},{"@svgdotjs/svg.js":"../../../node_modules/@svgdotjs/svg.js/dist/svg.esm.js"}],"../../js/services.js":[function(require,module,exports) {
"use strict";
...
var _consultancyHeaderAnims = require("./consultancyHeaderAnims");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _consultancyHeaderAnims.animateConultancyHeaderStart)(); // Animate on scroll

var pathRefOnScroll = (0, _svg.SVG)('#branch-1-path-5'); // const plantSvgBg = SVG(".svg-background");

var plantSvgBg = (0, _svg.SVG)().addTo('.plant-based-background').attr({
  class: "svg-background"
});
var upperPlantSVG = (0, _svg.SVG)("#path79-7-9");
var plantBaseElRef = document.querySelector(".svg-background");
pathRefOnScroll.stroke({
  opacity: 0
});
var consultancySvgBg = (0, _svg.SVG)(".consultancy-background svg"); // instantiate the scrollama

var scroller = (0, _scrollama.default)(); // setup the instance, pass callback functions

scroller.setup({
  step: ".section-plant-based",
  offset: 0.9
}).onStepEnter(function (response) {
  pathRefOnScroll.attr({
    class: "path-anim-slow"
  });
  var pathRefOnScrollLen = pathRefOnScroll.length();
  pathRefOnScroll.stroke({
    opacity: 1,
    dasharray: pathRefOnScrollLen,
    dashoffset: pathRefOnScrollLen
  });
  var pathEndViewbox = pathRefOnScroll.pointAt(pathRefOnScrollLen);
  var pathEndNorm = pathEndViewbox.x / consultancySvgBg.viewbox().w;
  var pathEndXtoNewSvg = pathEndNorm * window.innerWidth; // let pathEndNorm = pathEndViewbox.x;

  setTimeout(function () {
    var outstretchPath = plantSvgBg.path("\n                        m ".concat(pathEndXtoNewSvg, ",-50 \n                        c 0,-10 \n                        0,30 \n                        0,0\n                ")).animate(400).ease("-").plot("\n                m ".concat(pathEndXtoNewSvg, ",50 \n                c 0,-10 \n                0,30 \n                0,50\n        ")).after(function () {
      var xOffsets = [0, 45, 90];
      xOffsets.forEach(function (offset) {
        var bottomLeaf = plantSvgBg.path("m ".concat(pathEndXtoNewSvg - offset, ",100 c 1.02317,35.72951 -20.85645,59.47437 -56.5659,60.98511"));
        bottomLeaf.attr({
          class: "leaf-anim"
        });
        var bottomLeafLength = bottomLeaf.length();
        bottomLeaf.stroke({
          dasharray: bottomLeafLength,
          dashoffset: bottomLeafLength
        });
        var topLeaf = plantSvgBg.path("m ".concat(pathEndXtoNewSvg - offset, ",100 c -35.73574,1.51185 -57.63147,25.27418 -56.60754,61.02999"));
        topLeaf.attr({
          class: "leaf-anim"
        });
        topLeaf.stroke({
    ...
    }) // Shrink out extension
    .animate(300).plot("\n                m ".concat(pathEndXtoNewSvg, ",100 \n                c 0,0 \n                0,0 \n                0,0\n        "));
  }, 1400);
});
window.addEventListener("resize", function () {
  scroller.resize();
});
},{"@svgdotjs/svg.js":"../../../node_modules/@svgdotjs/svg.js/dist/svg.esm.js","scrollama":"../../../node_modules/scrollama/build/scrollama.js","./consultancyHeaderAnims":"../../js/consultancyHeaderAnims.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../../js/services.js"], null)
//# sourceMappingURL=/services.f7fed30d.js.map